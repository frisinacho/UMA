...
public class DataSetFactory {
	...
	/// NUEVOS M�TODOS PARA LA PR�CTICA
	// iris90 tiene el 90% de los ejemplos (entrenamiento)
	// iris10 tiene el 10% restante (validaci�n)
	
	public static DataSet getIrisDataSet90() throws Exception {
		DataSetSpecification spec = createIrisDataSetSpec();
		return new DataSetFactory().fromFile("iris90", spec, ",");
	}
	public static DataSet getIrisDataSet10() throws Exception {
		DataSetSpecification spec = createIrisDataSetSpec();
		return new DataSetFactory().fromFile("iris10", spec, ",");
	}
